...
class LinkPager extends Widget
{
    ...
    protected function renderPageButtons()
    {
        ...
        /****增加总页数***/
        $buttons[] = Html::tag('li', Html::tag("span", ($currentPage+1).'/'.$this->pagination->getPageCount().'页'), ['class'=>$this->pageCssClass]);
        ...
        $goHtml = <<<goHtml
     <li><input class="input" type="number" value="{$_currentPage}" min="1" max="{$pageCount}" aria-label="" style="text-align: center; height: 25px; line-height: 25px; margin-top: 5px; width: 30px;"></li>
     <li><button type="button" class="go-page layui-btn layui-btn-sm">确定</button></li>
goHtml;
        $buttons[] = $goHtml;
    ...
    $(".go-page").on("click", function () {
     var _this = $(this),
      _pageInput = _this.parent().prev().children(".input"),
